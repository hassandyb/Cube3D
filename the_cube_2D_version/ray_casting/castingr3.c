...
/*   Updated: 2024/01/07 11:56:49 by hed-dyb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_special_case_r3(t_prime *prime)
{
	...
	pt_x = (i * IMG_SIZE) - 5;// i think we should incremet the pt_x cause we theck the left one !!
...
void ft_find_l_len_r3(t_prime *prime)
{
	...
	pt_y = prime->player.py - prime->ray.deltay -5 ;// i think yu should add -5 or -2 ....
...
void ft_find_c_len_r3(t_prime *prime)
{
	...
	pt_x = prime->player.px - prime->ray.deltax - 5;// to check the left one
