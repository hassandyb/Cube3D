...
/*   Updated: 2024/01/07 11:57:26 by hed-dyb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_special_case_r4(t_prime *prime)
{
	...
	pt_y = (j * IMG_SIZE) - 5;// -5 for the same reasons
...
void ft_find_l_len_r4(t_prime *prime)
{
	...
	pt_y = prime->player.py - prime->ray.deltay - 5;// for the same reasons
...
void ft_find_c_len_r4(t_prime *prime)
{
	...
	alpha = prime->ray.r_angle - (3 * M_PI / 2);
	pt_x = prime->player.px + prime->ray.deltax;
	pt_y = prime->player.py - prime->ray.deltay;// testing
