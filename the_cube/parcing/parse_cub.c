...
/*   Updated: 2024/01/20 16:34:29 by hed-dyb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_norm(t_parse *parse, int i, int j, int len)
{
	...
	|| parse->map[i][j] == 'E')
	{
		if (i == 0 || i == parse->mapsize - 1 || j == 0 || j == len - 1)
			ft_error("Error: Map is not closedd\n");
